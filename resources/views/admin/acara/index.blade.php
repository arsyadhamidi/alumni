            ...
            <div class="col-lg">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('data-acara.create') }}" class="btn btn-primary">
                            ...
                            <tbody>
                                @foreach ($acaras as $data)
                                    <tr>
                                        ...
                                        <td>{{ $data->jadwal ?? '-' }}</td>
                                        <td class="d-flex">
                                            <form action="{{ route('data-acara.destroy', $data->id) }}" method="POST">
                                                @csrf
                                                <a href="{{ route('data-acara.edit', $data->id) }}" class="btn btn-sm btn-outline-info">
