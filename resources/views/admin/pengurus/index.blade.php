            ...
            <div class="col-lg">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('data-pengurus.create') }}" class="btn btn-primary">
                            <i class="fas fa-plus"></i>
                            Tambahkan Data Pengurus Alumni
                        </a>
                    </div>
                            ...
                            <tbody>
                                @foreach ($pengurus as $data)
                                    <tr>
                                        ...
                                        <td>{{ $data->telp ?? '-' }}</td>
                                        <td class="d-flex">
                                            <form action="{{ route('data-pengurus.destroy', $data->id) }}" method="POST">
                                                @csrf
                                                <a href="{{ route('data-pengurus.edit', $data->id) }}" class="btn btn-sm btn-outline-info">
