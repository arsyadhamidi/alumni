            ...
            <div class="col-lg">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('data-alumni.index') }}" class="btn btn-primary">
                            <i class="fas fa-arrow-left"></i>
                            Kembali
                        </a>
                        <a href="{{ route('data-alumni.create', $jurusans->id) }}" class="btn btn-primary">
                            ...
                            <tbody>
                                @foreach ($alumnis as $data)
                                    <tr>
                                        ...
                                        <td>{{ $data->telp ?? '-' }}</td>
                                        <td class="d-flex">
                                            <form action="{{ route('data-alumni.destroy', $data->id) }}" method="POST">
                                                @csrf
                                                <a href="{{ route('data-alumni.edit', $data->id) }}" class="btn btn-sm btn-outline-info">
