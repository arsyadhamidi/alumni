...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg">
                <form action="{{ route('data-pekerjaan.update', $pekerjaans->id) }}" method="POST">
                    @csrf
                    <div class="card">
                                ...
                                <div class="col-lg">
                                        ...
                                        <select name="alumni_id" class="form-control @error('alumni_id') is-invalid @enderror"
                                            ...
                                            @foreach ($alumnis as $data)
                                                <option value="{{ $data->id }}"
                                                    {{ $pekerjaans->alumni_id == $data->id ? 'selected' : '' }}>
                                                    {{ $data->nama ?? '-' }}</option>
                                            @endforeach
                                        </select>
                                        @error('alumni_id')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nama"
                                            ...
                                            value="{{ old('nama', $pekerjaans->nama ?? '-') }}" placeholder="Masukan Pekerjaan">
                                        @error('nama')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="tempat"
                                            ...
                                            value="{{ old('tempat', $pekerjaans->tempat ?? '-') }}" placeholder="Masukan tempat pekerjaan">
                                        @error('tempat')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="jenis_pekerjaan"
                                            ...
                                            value="{{ old('jenis_pekerjaan', $pekerjaans->jenis_pekerjaan ?? '-') }}" placeholder="Masukan jenis pekerjaan">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror" rows="5" placeholder="Masukan alamat pekerjaan">{{ old('alamat', $pekerjaans->alamat ?? '-') }}</textarea>
                                        @error('alamat')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
