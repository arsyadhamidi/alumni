            ...
            <div class="col-lg">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('data-pekerjaan.create') }}" class="btn btn-primary">
                            <i class="fas fa-plus"></i>
                            Tambahkan Data Pekerjaan
                        </a>
                    </div>
                            ...
                            <tbody>
                                @foreach ($pekerjaans as $data)
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            <form action="{{ route('data-pekerjaan.destroy', $data->id) }}" method="POST">
                                                @csrf
                                                <a href="{{ route('data-pekerjaan.edit', $data->id) }}" class="btn btn-sm btn-outline-info">
