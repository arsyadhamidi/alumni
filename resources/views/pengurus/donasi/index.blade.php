            ...
            <div class="col-lg">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('pengurus-donasi.create') }}" class="btn btn-primary">
                            ...
                            <tbody>
                                @foreach ($donasis as $data)
                                    <tr>
                                        ...
                                        <td class="d-flex">
                                            <form action="{{ route('pengurus-donasi.destroy', $data->id) }}" method="POST">
                                                @csrf
                                                <a href="{{ route('pengurus-donasi.edit', $data->id) }}" class="btn btn-sm btn-outline-info">
