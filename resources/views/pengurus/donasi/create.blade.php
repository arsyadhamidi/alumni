...
@section('menuPengurusDonasi', 'active')
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg">
                <form action="{{ route('pengurus-donasi.store') }}" method="POST">
                    @csrf
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('pengurus-donasi.index') }}" class="btn btn-primary">
                                ...
                                <div class="col-lg">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="nama"
                                            ...
                                            value="{{ old('nama') }}" placeholder="Masukan nama donasi">
                                        @error('nama')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="jumlah_donasi"
                                            ...
                                            value="{{ old('jumlah_donasi') }}" placeholder="Masukan jumlah donasi">
                                        @error('jumlah_donasi')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
