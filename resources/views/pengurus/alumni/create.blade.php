...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg">
            <form action="{{ route('pengurus-alumni.store') }}" method="POST">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('pengurus-alumni.alumni', $jurusans->id) }}" class="btn btn-primary">
                        ...
                        <div class="row">
                            <div class="col-lg">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" value="{{ $jurusans->nama ?? '' }}" readonly>
                                </div>
                            </div>
                            <div class="col-lg">
                                <div class="mb-3">
                                    <label>NISN</label>
                                    <input type="text" name="nisn" class="form-control @error('nisn') is-invalid @enderror" value="{{ old('nisn') }}" placeholder="Masukan nisn">
                                    @error('nisn')
                        ...
                        <div class="row">
                            <div class="col-lg">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="tahunlulus" class="form-control @error('tahunlulus') is-invalid @enderror" value="{{ old('tahunlulus') }}" placeholder="Masukan Tahun Lulus">
                                    @error('tahunlulus')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
