...
class AdminAlumniController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('data-alumni.alumni', $request->jurusan_id)->with('success', 'Selamat ! Anda berhasil menambahkan data');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('data-alumni.alumni', $request->jurusan_id)->with('success', 'Selamat ! Anda berhasil memperbaharui data');
    }
