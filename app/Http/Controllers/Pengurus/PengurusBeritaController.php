...
class PengurusBeritaController extends Controller
{
    public function index()
    {
        $beritas = Berita::latest()->get();
        return view('pengurus.berita.index', [
            'beritas' => $beritas,
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('pengurus-berita.index')->with('success', 'Selamat ! Anda berhasil menambahkan data');
    }

    public function edit($id)
    {
        return view('pengurus.berita.edit', [
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('pengurus-berita.index')->with('success', 'Selamat ! Anda berhasil memperbaharui data');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('pengurus-berita.index')->with('success', 'Selamat ! Anda berhasil menghapus data');
    }
}
